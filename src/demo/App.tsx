...
const App = () => (
  <div>
    ...
    <p>
      ...
      <code>src/lib/examples/DescribedComponent</code> folder (i.e. BasicExample
      hashed on code of this demo).
    </p>
    ...
    <p>
      To fire up examples of usage import any component from{" "}
      <code>src/lib/examples/DescribedButton</code> folder (i.e. BasicExample
      hashed on code of this demo).
    </p>
    {/*<div><BasicExample /></div>*/}
    <h3>Playground</h3>
